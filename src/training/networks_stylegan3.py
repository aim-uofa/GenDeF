...
from src.torch_utils3.ops import conv2d_gradfix
from src.torch_utils3.ops import filtered_lrelu
from src.torch_utils3.ops import bias_act
...
class SynthesisLayer(torch.nn.Module):
    def __init__(self,
        ...
        if self.dcn:
            ...
            self.dcn_weight = torch.nn.Parameter(torch.randn([dcn_out_channel, in_channels, self.conv_kernel, self.conv_kernel]))
